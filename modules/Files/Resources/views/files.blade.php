    ...
    <section id="main-content">
        ...
        <div class="files-left">
            <ul class="list-folder">
                <li><a href="/manager/files/manager"><i
                                class="fa <?php echo ($id == 0) ? 'fa-folder-open' : 'fa-folder'; ?>"></i> All</a></li>
                <?php foreach($folders as $v) { ?>
                <li class="folder-right-click" data-id="{{(string)$v['id']}}" data-name="<?php echo $v['name']?>"><a
                            href="/manager/files/manager/{{$v['id']}}"><i
                                class="fa <?php echo ($id == $v['id']) ? 'fa-folder-open' : 'fa-folder' ?> "></i> <?php echo $v['name']?>
                    </a></li>
                <?php } ?>


            </ul>
            <div aria-hidden="true" aria-labelledby="form-newfolder" role="dialog" tabindex="-1" id="form-newfolder"
        ...
        <div class="files-right">
            <div class="col-sm-12 listfile-right ">
                <div class="btn-group pull-right action-popup">
                    <button type="button" class="btn btn-white btn-sm upload-photos"><i class="fa fa-upload"></i> Upload
                        New File
                    </button>
                    <button type="button" class="btn btn-white btn-sm" onclick="window.location.reload()"><i
                                class="fa fa-folder-open"></i> Refresh
                    </button>
                    <form action="/manager/files/index/{{$id}}" type="post" enctype="multipart/form-data" name="frm1">
                        ...
                        <div class="row div_search">
                            ...
                            <div class="col-xs-1 col-sm-1"><input type="submit" name="" value="Search"
                                                                  class="btn btn-success btn-info btn-sm"></div>
                ...
                <!-- Modal -->
                <div class="modal fade" id="photo-detail" tabindex="-1" role="dialog" aria-labelledby="image-detail"
                     aria-hidden="true">
                        ...
                        <form id="form-edit-file" method="post">
                            <div class="modal-content">
                                ...
                                <div class="modal-body row">
                                    ...
                                    <div class="col-md-5 col-xs-5 img-modal">
                                        <img id="image_preview" style="width: 200px;height: 200px"
                                             src="/images/admin/noimage.jpg" alt="">

                                        <p class="mtop10"><strong>File Name:</strong> <span id="photo-filename"></span>
                                        </p>
                                    ...
                                    <div class="col-md-7 col-xs-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="url" id="input-photo-link" readonly="readonly" value=""
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button id="update-media" class="btn btn-primary" type="button">Save changes
                                    </button>
                ...
                <!-- modal -->
                <div aria-hidden="true" aria-labelledby="form-upload-photos" role="dialog" tabindex="-1"
                     id="form-upload-photos" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
